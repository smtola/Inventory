...
class StatsOverview extends BaseWidget
{
    protected function getStats(): array
    {
        ...
        // --- New Orders ---
        $newOrders = Order::whereMonth('order_date', now()->month)->count();
        ...
        $ordersLast7Days = collect(range(6, 0, -1))
            ->map(fn($daysAgo) => Order::whereDate('order_date', now()->subDays($daysAgo))->count())
            ->toArray();
        ...
        Stat::make('New Orders', number_format($newOrders / 1000, 2) . 'K')
